...
class PatientData(BaseModel):
    gender: Literal['Male', 'Female', 'Other'] = Field(title="Gender", description="Gender of the patient")
    age: int = Field(gt=0, title="Age", description="Age of the patient in years")
    hypertension: bool = Field(default=False, title="Hypertension", description="Whether the patient has hypertension")
    heart_disease: bool = Field(default=False, title="Heart Disease", description="Whether the patient has heart disease")
    ever_married: bool = Field(default=False, title="Ever Married", description="Whether the patient has ever been married")
    ...
    avg_glucose_level: float = Field(gt=0, title="Average Glucose Level", description="Average glucose level of the patient")
...
class StrokePrediction(BaseModel):
    ...
    confidence: float = Field(gt=0, le=1, title="Confidence", description="Confidence level of the stroke prediction")
